!(function (t, i) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : i(
        ((t =
          "undefined" != typeof globalThis ? globalThis : t || self).countUp =
          {})
      );
})(this, function (t) {
  "use strict";
      ...
      function t(t, n, s) {
        ...
        (this.endVal = n),
            ...
            (e.remaining = e.duration - i),
              e.useEasing
                ? e.countDown
                  ? (e.frameVal =
                      e.startVal -
                      e.easingFn(i, 0, e.startVal - e.endVal, e.duration))
          ...
          (this.formatNumber = function (t) {
            ...
            if (
              ((n = r[0]),
              (s = r.length > 1 ? e.options.decimal + r[1] : ""),
              e.options.useGrouping)
            ) {
              a = "";
              for (var l = 3, u = 0, h = 0, p = n.length; h < p; ++h)
                e.options.useIndianSeparators && 4 === h && ((l = 2), (u = 1)),
                  0 !== h && u % l == 0 && (a = e.options.separator + a),
                  u++,
                  (a = n[p - h - 1] + a);
              n = a;
            }
